...
The prototype for the callback functions follow the paradigms of the way command line
agruments are passed into the respective 'main' for each language as shown below:
